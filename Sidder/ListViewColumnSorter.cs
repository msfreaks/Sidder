...
public class ListViewColumnSorter : IComparer
{
    ...
    public int Compare(object x, object y)
    {
        ...
        else if (int.TryParse(listviewX.SubItems[ColumnToSort].Text, out sizeX) && int.TryParse(listviewY.SubItems[ColumnToSort].Text, out sizeY))
        {
...
class Sorter : System.Collections.IComparer
{
    ...
    public int Compare(object x, object y) // IComparer Member
    {
        ...
        else if (l1.ListView.Columns[Column].Tag.ToString() == "DateTime")
        {
            DateTime dt1 = DateTime.Parse(l1.SubItems[Column].Text);
            DateTime dt2 = DateTime.Parse(l2.SubItems[Column].Text);
